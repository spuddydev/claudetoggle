...
Do NOT run any bash to read or modify `~/.claude/toggles/.state/devlog/*` — direct writes are blocked, and the toggle authority belongs solely to the user via `/devlog`.
