...
Do NOT run any bash to read or modify `~/.claudetoggle/state/coauth/*` — direct writes are blocked, and the toggle authority belongs solely to the user via `/coauth`.
